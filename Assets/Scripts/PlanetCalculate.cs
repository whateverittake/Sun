...
public class PlanetCalculate : MonoBehaviour
{
	 ...
	 */
	public Vector3 CalculateSunPosition(
		DateTime dateTime, float latitude, float longitude)
	{
		...
		return new Vector3((float)altitude * Mathf.Rad2Deg, (float)azimuth * Mathf.Rad2Deg, 0);
	}
